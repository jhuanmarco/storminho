...
public class Variables {
	...
	public static final int PRINTCONTROL = 1000;
	...
	*/
	public static final SelectedTag kernelType = new SelectedTag(LibSVM.KERNELTYPE_RBF, LibSVM.TAGS_KERNELTYPE);
	/*	(Default RBF)
	...
	*/	
	public static final boolean SVM_VARIABLES = true; // Variables control
	public static final double coef0 = 0.25; 	//  (Default 0) -- POLY, SIGMOID -- 
	public static final int degree = 13;		//7 (Default 3)  -- POLY -- 
    ...
    public static final int TOTAL_PARES = 411100; 
    //==========================================================================
    ...
    public final static String DATASET_INPUT = "dados10";
    //=========================================================== ===============
