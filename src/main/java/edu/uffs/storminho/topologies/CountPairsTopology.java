...
import edu.uffs.storminho.bolts.CountPairsBolt;
...
public class CountPairsTopology {

  public static void main(String[] args) throws Exception {
    TopologyBuilder builder = new TopologyBuilder();
    Jedis jedis = new Jedis("localhost");
    jedis.flushAll();
    Variables.COUNT_MODE = true;

    if(!SharedMethods.dataFolderExists() && Variables.FOLDER_CONTROL) {
    ...
    builder.setBolt("count-pairs", new CountPairsBolt(), 1).shuffleGrouping("pair-ranker");
    ...
    if (args != null && args.length > 0) {
      ...
      Thread.sleep(300000);
      cluster.shutdown();
      System.out.println("acabou o cao");
    }
  }
}
