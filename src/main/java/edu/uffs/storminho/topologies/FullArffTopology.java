...
import edu.uffs.storminho.bolts.FullCreatorBolt;
...
public class FullArffTopology {
  ...
  public static void main(String[] args) throws Exception {
    ...
    builder.setBolt("full-creator", new FullCreatorBolt(), 1).shuffleGrouping("pair-ranker");
