...
public class SharedMethods {
  ...
  //get training count from in folder
    ...
    //set output file
    public static void setOutputFile(double precisao, double revocacao, long vp, long vn, long fp, long fn) throws IOException {
    	...
    	if(classifier == "SVM") {
    		toAppend += ", SVMTYPE: " + Variables.SVMtype.toString()
				...
				+ ", COEF:" + Double.toString(Variables.coef0)
